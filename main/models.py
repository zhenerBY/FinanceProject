...
class ApiUser(models.Model):
    ...
    date_filter_start = models.DateTimeField(null=True, blank=True, default=None, verbose_name=_('Date filter start'))
    date_filter_end = models.DateTimeField(null=True, blank=True, default=None, verbose_name=_('Date filter end'))
